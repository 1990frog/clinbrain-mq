...
public class ConsumerRegistryHelper {
    ...
    private XxlRpcAdminRegister serviceRegistry;
    public ConsumerRegistryHelper(XxlRpcAdminRegister serviceRegistry) {
    ...
    public void registerConsumer(List<ConsumerThread> consumerThreadList) {
        ...
        List<XxlRpcAdminRegistryDataParamVO> registryParamList = new ArrayList<>();
        ...
        for (ConsumerThread consumerThread: consumerThreadList) {
            ...
            registryParamList.add(new XxlRpcAdminRegistryDataParamVO(registryKey, registryVal));
            registryParamKeyList.add(registryKey);
        }

        // registry mult consumer
        serviceRegistry.getXxlRpcAdminRegistryClient().registry(registryParamList);

        // discovery mult consumer
        serviceRegistry.getXxlRpcAdminRegistryClient().discovery(registryParamKeyList);
    }
    ...
    public void removeConsumer(List<ConsumerThread> consumerThreadList){
        ...
        serviceRegistry.getXxlRpcAdminRegistryClient().remove(registryParamList);
    }
