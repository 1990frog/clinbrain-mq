...
public class UContactExample {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        public Criteria andEnabledLike(Integer value) {
            addCriterion("enabled like", value, "enabled");
            return (Criteria) this;
        }

        public Criteria andEnabledNotLike(Integer value) {
        ...
        public Criteria andUpdateTimeNotBetween(Date value1, Date value2) {
		 ...
		 public Criteria andLikeQuery(UContact record) {
			...
			if(record.getContactName()!=null&&StrUtil.isNotEmpty(record.getContactName().toString())) {
    			 list.add("ifnull(contact_name,'')");
    		}
			...
			if(record.getContactName()!=null&&StrUtil.isNotEmpty(record.getContactName().toString())) {
    			list2.add("'%"+record.getContactName()+"%'");
    		}
			if(record.getNickname()!=null&&StrUtil.isNotEmpty(record.getNickname().toString())) {
