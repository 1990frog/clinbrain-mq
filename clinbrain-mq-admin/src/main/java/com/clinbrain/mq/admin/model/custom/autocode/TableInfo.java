package com.clinbrain.mq.admin.model.custom.autocode;
...
public class TableInfo {
    ...
    public String tableToJava(String tableName) {
    	String tablePrefix= com.clinbrain.mq.model.custom.autocode.AutoCodeConfig.getConfig().getString("tablePrefix");
