package com.clinbrain.mq.admin.controller.admin;
...
import com.clinbrain.mq.admin.common.base.BaseController;
import com.clinbrain.mq.admin.common.domain.AjaxResult;
import com.clinbrain.mq.admin.common.domain.ResuTree;
import com.clinbrain.mq.admin.common.domain.ResultTable;
import com.clinbrain.mq.admin.model.custom.TsysTables;
import com.clinbrain.mq.admin.model.custom.TsysTablesVo;
import com.clinbrain.mq.admin.model.custom.autocode.BeanColumn;
import com.clinbrain.mq.admin.model.custom.autocode.TableInfo;
import com.clinbrain.mq.admin.service.GeneratorService;
import com.clinbrain.mq.admin.util.AutoCode.AutoCodeUtil;
...
public class AutoCodeController extends BaseController {
	...
	public String global(ModelMap modelMap) {
		modelMap.put("author", com.clinbrain.mq.model.custom.autocode.AutoCodeConfig.getConfig().getProperty("author"));
		modelMap.put("email", com.clinbrain.mq.model.custom.autocode.AutoCodeConfig.getConfig().getProperty("author"));
		modelMap.put("parentPath", com.clinbrain.mq.model.custom.autocode.AutoCodeConfig.getConfig().getProperty("parentPath"));
	...
	@ResponseBody
	public AjaxResult createAuto(com.clinbrain.mq.model.custom.autocode.AutoConfigModel autoConfigModel) {
		// 根据表名查询表字段集合
	...
	@ResponseBody
	public void createAutoZip(com.clinbrain.mq.model.custom.autocode.AutoConfigModel autoConfigModel, HttpServletResponse response) throws IOException {
		byte[] b;
		...
		response.reset();
		response.setHeader("Content-Disposition", "attachment; filename=\"mq.zip\"");
	 ...
	 */
	@GetMapping("/viewAuto")
	public String viewAuto(com.clinbrain.mq.model.custom.autocode.AutoConfigModel autoConfigModel, ModelMap model) {
		List<BeanColumn> list = generatorService.queryColumns2(autoConfigModel.getTableName());
		TableInfo tableInfo = new TableInfo(autoConfigModel.getTableName(), list, autoConfigModel.getTableComment());
