...
import com.clinbrain.mq.mapper.auto.SysNoticeMapper;
import com.clinbrain.mq.mapper.auto.SysNoticeUserMapper;
import com.clinbrain.mq.model.auto.*;
import com.clinbrain.mq.model.auto.SysNoticeUserExample.Criteria;
	 ...
	 */
	 public PageInfo<SysNotice> list(TsysUser tsysUser,Tablepar tablepar,String name){
			...
			if(noticeUsers!=null&&noticeUsers.size()>0) {
		        ...
		        com.clinbrain.mq.model.auto.SysNoticeExample.Criteria criteria1= testExample.createCriteria();
		        if(name!=null&&!"".equals(name)){
